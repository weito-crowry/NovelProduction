...
def test_fresh_reference_work_full_analysis_does_not_nest_transactions(
    ...
    try:
        ...
        assert semantics["analysis_status"]["basic"] == {
            "state": "current",
            "reasons": [],
        }
        connection.execute(
    ...
    try:
        ...
        cursor = connection.execute(
            ...
            (
                json.dumps(
                    {
                        "reference_work_id": imported.reference_work_id,
        ...
        class _RevisionChangingOrchestrator:
            ...
            def analyze_document(self, **kwargs: object) -> DocumentAnalysisResult:
                observed_rebuild.append(kwargs["rebuild_structure"])
