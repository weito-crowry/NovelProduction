...
async function invalidateInformationQueries(projectId: string, queryClient: ReturnType<typeof useQueryClient>) { await Promise.all([queryClient.invalidateQueries({ queryKey: projectQueryKeys.informationFamily(projectId) }), queryClient.invalidateQueries({ queryKey: projectQueryKeys.informationSearchFamily(projectId) }), queryClient.invalidateQueries({ queryKey: projectQueryKeys.canonDecisionsFamily(projectId) }), queryClient.invalidateQueries({ queryKey: projectQueryKeys.canonDecisionSearchFamily(projectId) }), queryClient.invalidateQueries({ queryKey: projectQueryKeys.characterKnowledgeProjectFamily(projectId) }), queryClient.invalidateQueries({ queryKey: projectQueryKeys.episodeViews(projectId) })]); }
