...
from novel_mcp.errors import ValidationError
from novel_mcp.models.context import EffectiveRelationship
...
from novel_mcp.services.outline_service import GENERIC_GUARD
