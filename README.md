...
certification. Phase E structured draft editor work is not implemented yet;
migration 005, TipTap, and structured draft persistence remain Phase E. `CORE/`
owns the SQLite lifecycle,
